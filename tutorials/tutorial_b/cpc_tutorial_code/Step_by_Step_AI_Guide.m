...
rs1 = 2.5; % Risk-seeking parameter (set to the variable rs below) 
...
PEB = 1; % Note: GCM_2 and GCM_3 (the inputs to PEB; see below) are saved 
...
pHA = .7; % By default we set this to 1, but try changing its value to 
...
% world is volatile and that contingencies change over time.
    ...
    omega = .3; % By default we here set this to 0 (indicating no forgetting, 
